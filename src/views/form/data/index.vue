  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="表单版本" prop="formVersion">
        <el-input
          v-model="queryParams.formVersion"
          placeholder="请输入表单版本"
          clearable
          @keyup.enter="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="dataList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="关联的表单ID" align="center" prop="formId" />
      <el-table-column label="表单版本" align="center" prop="formVersion" />
      <el-table-column label="表单数据内容" align="center" prop="dataContent" />
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['form:data:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['form:data:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="dataRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="表单数据内容" prop="dataContent">
          <el-input v-model="form.dataContent" type="textarea" placeholder="请输入内容" />
        </el-form-item>
      </el-form>
      <template #footer>
