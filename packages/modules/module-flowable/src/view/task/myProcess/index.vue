...
<script>
import { delDeployment } from "@flowable/api/finished";
import { myProcessList, stopProcess } from "@flowable/api/process";
import { listDefinition } from "@flowable/api/definition";
export default {
  name: "Deploy",
  components: {
  },
