...
import FlowExp from '@flowable/components/Flow/Expression'
import ElInputTag from '@flowable/components/Flow/ElInputTag'
import { StrUtil } from '@ruoyi/core/utils/str'
import modelerStore from '@flowable/components/Process/common/global'
export default {
  name: "TaskPanel",
  components: {
    FlowUser,
