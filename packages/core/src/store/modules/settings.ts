import { getDefaultSettings, getSettingsRuntime, resolveMenuLayout, type CoreSettingsConfig, type MenuLayout } from '../../settings'
...
const storageSetting: Partial<CoreSettingsConfig> = JSON.parse(
  ...
  actions: {
    async initSetting() {
      ...
      try {
        ...
        const initDbSetting = settingsRuntime.initDbSetting || defaultSettings.initDbSetting
    ...
    /** 修改布局设置 */
    changeSetting(data: { key: keyof CoreSettingsConfig, value: any }) {
